...
export function DriverTodayPage() {
  ...
  const confirmations = useQuery({ queryKey: ['driver-confirmations', 'today'], queryFn: driverConfirmations, enabled })
  const trips = useQuery({ queryKey: ['trips', 'DRIVER', 'today'], queryFn: driverTrips, enabled })
