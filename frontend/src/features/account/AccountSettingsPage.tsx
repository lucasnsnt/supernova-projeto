...
function AccountForms({ initial }: { initial: Awaited<ReturnType<typeof accountDetails>> }) {
  ...
  return <div className="page-stack"><header className="page-heading profile-page-heading"><div><p className="eyebrow">Conta</p><h1>Minha conta</h1><p className="muted">Atualize os dados de acesso da administração.</p></div><LogoutButton /></header>
