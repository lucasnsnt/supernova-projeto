...
export type StudentDetails = { account: Omit<ProfilePayload, 'address'> & { email: string; address: Address | null }; institution: Institution | null; profileStatus: ProfileStatus }
