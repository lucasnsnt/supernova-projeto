...
const trip: Trip = { id: 4, serviceDate: '2026-09-15', direction: 'VOLTA', status: 'PLANNED', departureAt: '2026-09-15T12:00:00', planningIssue: null, startedAt: null, completedAt: null, cancellationReason: null, encodedPolyline: null, completedStopCount: 0, vehicle: { id: 1, model: 'Ducato', licensePlate: 'ABC1234' }, participants: [{ studentId: 2, studentName: 'Ana', institutionName: 'Faculdade', pickupOrder: 1, dropoffOrder: 2, estimatedPickupAt: '2026-09-15T12:10:00', estimatedDropoffAt: '2026-09-15T12:30:00', pickupAddress: null, dropoffAddress: null }] }
...
it('mostra erro ao iniciar e mantém a viagem planejada', async () => {
  ...
  expect(screen.queryByRole('button', { name: 'Abrir viagem' })).not.toBeInTheDocument()
})
