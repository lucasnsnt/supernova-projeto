...
const navigation: Record<Role, NavigationItem[]> = {
  STUDENT: [{ to: '/', label: 'Hoje', symbol: '⌂' }, { to: '/rotas', label: 'Rotas', symbol: '⌁' }, { to: '/agenda', label: 'Agenda', symbol: '▣' }, { to: '/viagens', label: 'Viagens', symbol: '↗' }, { to: '/meu-cadastro', label: 'Meu cadastro', symbol: '◉' }],
  DRIVER: [{ to: '/', label: 'Hoje', symbol: '⌂' }, { to: '/rotas', label: 'Rotas', symbol: '⌁' }, { to: '/alunos', label: 'Alunos', symbol: '◉' }, { to: '/viagens', label: 'Viagens', symbol: '↗' }, { to: '/meu-cadastro', label: 'Meu cadastro', symbol: '◇' }],
